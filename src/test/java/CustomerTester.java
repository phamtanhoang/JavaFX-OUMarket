...
public class CustomerTester {
    ...
    public void testAddCustomer() throws SQLException {
        ...
        Customer customer = new Customer("Ngọc Trinh", Date.valueOf("2002-12-05"), "Nữ", "0362400302", "ngọctrinh@gmail.com");
        ...
        Assertions.assertEquals(customer.getDateOfBirth(),retrievedCustomer.getDateOfBirth());
    }
    @Test
    @DisplayName("Kiểm tra sửa khách hàng")
    public void testUpdateCustomer() throws SQLException {
        Customer customer = new Customer("Ngọc Trinh", Date.valueOf("2002-12-06"), "Nữ", "0362400203", "ngoctrinh2@gmail.com");
        ...
        Customer updatedCus= new Customer(customer.getId(),"Ngọc Trinh1",  Date.valueOf("2002-12-06"), "Nữ", "0362400233", "ngoctrinh02@gmail.com");
    ...
    public void testDeleteBranch() throws SQLException {
        ...
        Customer customer = new Customer("abcabc",  Date.valueOf("2002-12-06"), "Nữ", "03624002323", "ngoctrinh23@gmail.com");
